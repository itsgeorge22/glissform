...
- Builds a Gaussian blur pyramid once from each screenshot, filters and shades in linear light, and uses a subtle fixed dither to reduce visible steps in broad frost and shadow gradients. The flat screenshot remains sharp and unchanged by the material.
