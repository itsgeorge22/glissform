...
**In development — not yet available for public download.** The current development version is 0.1.0-alpha.6.
...
- Choose the starting angle and optionally restore desktop access after a two-second pause.
